...
namespace AmazonGameLift.Editor
{
    internal sealed class TextProvider
    {
        ...
        private readonly Dictionary<string, string> _textsByKey = new Dictionary<string, string>
        {
            ...
            { Strings.UserProfilePageAccountCardNoAccountButton, "Create an AWS Account"},
            { Strings.UserProfilePageAccountExistingAccountTitle, "I have an AWS account for this project"},
            { Strings.UserProfilePageAccountExistingAccountDescription, "Create a user profile and link it to your AWS account. You need security credentials for an account user."},
            ...
            { Strings.UserProfilePageBootstrapPricingText, "This action might incur a charge. See Amazon GameLift pricing."},
            { Strings.UserProfilePageBootstrapPricingFreeTierText, "What is AWS Free Tier?"},
            { Strings.UserProfilePageBootstrapProfileInputText, ""},
            { Strings.UserProfilePageBootstrapBucketText, ""},
            { Strings.UserProfilePageBootstrapBucketUnsetText, ""},
