...
namespace AmazonGameLift.Editor
{
    internal sealed class TextProvider
    {
        ...
        private readonly Dictionary<string, string> _textsByKey = new Dictionary<string, string>
        {
            ...
            { Strings.AnywherePageConfigureClientButton, "Configure Client"},
            { Strings.AnywherePageLaunchClientLabel, "Launch Client"},
            { Strings.AnywherePageLaunchClientDescription, "Build and launch your game client."},
            ...
            { Strings.ManagedEC2ConfigureClientButton, "Configure Client"},
