...
namespace AmazonGameLift.Editor
{
    public sealed class TextProvider
    {
        ...
        private readonly Dictionary<string, string> _textsByKey = new Dictionary<string, string>
        {
            ...
            { Strings.LinkAccountCardNoAccountDescription, "Learn More."},
            { Strings.ButtonAccountCardNoAccount, "Create an AWS Account"},
            { Strings.LabelAccountExistingAccountTitle, "I have an AWS account for this project"},
            { Strings.LabelAccountExistingAccountDescription, "Create a user profile and link it to your AWS account. You need security credentials for an account user."},
            ...
            { Strings.DropdownAccountNewProfileRegionPlaceholder, "Choose a region"},
            { Strings.ButtonAccountNewProfileCreate, "Create Profile"},
            { Strings.ButtonAccountNewProfileCancel, "Cancel"},
            { Strings.LinkAccountNewProfileHelp, "How do I get my AWS credentials?"},
            ...
            { Strings.LinkBootstrapPopupFreeTier, "What is AWS Free Tier?"},
