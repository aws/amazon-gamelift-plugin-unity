...
namespace AmazonGameLift.Editor
{
    internal sealed class TextProvider
    {
        ...
        private readonly Dictionary<string, string> _textsByKey = new Dictionary<string, string>
        {
            ...
            { Strings.ManagedEC2ScenarioFlexFleetLabel, "Flex Match"},
            { Strings.ManagedEC2ScenarioFlexFleetRadio, "Uses FlexMatch, a managed matchmaking service, to match game players together."},
            { Strings.ManagedEC2ScenarioFlexFleetLink, "Learn more"},
