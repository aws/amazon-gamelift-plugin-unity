...
namespace AmazonGameLift.Editor
{
    internal sealed class TextProvider
    {
        private readonly Dictionary<string, string> _errorMessagesByCode = new Dictionary<string, string>
        {
            ...
            { CoreErrorCode.BucketNameIsWrong, "The bucket name is too long."},
        ...
        private readonly Dictionary<string, string> _textsByKey = new Dictionary<string, string>
        {
            ...
            { Strings.LabelCredentialsSelectProfileName, "Select Profile Name"},
            ...
            { Strings.LabelDeploymentStartButton, "Deploy"},
            { Strings.LabelDeploymentCancelButton, "Cancel"},
            ...
            { Strings.LabelSettingsAwsCredentialsSetUpButton, "AWS Credentails"},
            { Strings.LabelAwsCredentialsUpdateButton, "Update AWS Credentails"},
            { Strings.LabelPasswordHide, "Hide"},
            { Strings.LabelPasswordShow, "Show"},
            { Strings.LabelSettingsAllConfigured, "GameLift Plugin is fully configured! Try building the sample client and server and deploy a scenario in GameLift > Deployment. "},
            ...
            { Strings.TooltipSettingsAwsCredentials, "Create a new AWS account or use an existing one"},
            { Strings.TooltipSettingsBootstrap, "Create a new S3 bucket or use an existing one"},
            { Strings.TooltipSettingsDotNet, "Set up the recommended .Net version"},
            { Strings.TooltipSettingsJava, "Download the latest Java version"},
            { Strings.TooltipSettingsLocalTesting, "Download the GameLift file on your local machine and specify the path to it"},
