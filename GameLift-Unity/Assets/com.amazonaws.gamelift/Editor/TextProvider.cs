...
namespace AmazonGameLift.Editor
{
    internal sealed class TextProvider
    {
        ...
        private readonly Dictionary<string, string> _textsByKey = new Dictionary<string, string>
        {
            ...
            { Strings.LabelLocalTestingJarPath, "GameLift Local path"},
            { Strings.LabelLocalTestingServerPath, "Game Server Executable Path"},
            ...
            { Strings.TooltipSettingsJava, "Download the latest Java Runtime Environment (JRE) in order to run GameLift Local"},
